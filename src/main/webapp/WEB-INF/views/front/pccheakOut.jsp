...
<!-- main -->
					...
					<div class="right_allcont">
						<div class="order-cal bd-t">
							<div class="total-price">
								<span>Total:</span>
								<em>11</em>
								<span class="text num_Total">$0</span>
							</div>
							<div class="total-price">
								<span>Coupon:</span>
								<span class="text num_coupon">$0</span>
							</div>
							<div class="total-price">
								<span>Shopping freight:</span>
								<span class="text num_shop">$0</span>
							</div>
							<div class="total-price">
								<span>productsTotal:</span>
								<span class="text num_prout">$0</span>
							</div>
	...
	<script>
		...
		$('.win-box-title .save').on('click', function () {
